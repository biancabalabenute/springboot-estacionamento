...
import com.balabenute.demo_park_api.entity.Usuario;
...
import com.balabenute.demo_park_api.web.dto.mapper.UsuarioMapper;
...
@Tag(name = "Usuarios", description = "Contem todas as operações referentes aos recursos para cadastro, edição e leitura de um usuario.")
...
public class UsuarioController {
    ...
    @Operation(summary = "Recuperar todos os usuários cadastrados", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso recuperado com sucesso",
